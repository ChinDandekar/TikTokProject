...
class Tiktokdata(torch.utils.data.Dataset):
    """
    Tiktokdata video loader. Construct the Tiktokdata video loader, then sample
    ...
    def __init__(self, cfg, mode, num_retries=100):
        """
        Construct the Tiktokdata video loader with a given csv file. The format of
        the csv file is:
        ```
        ...
        assert mode in [
            ...
            "val",
            "test",
        ], "Split '{}' not supported for Tiktokdata".format(mode)
        self.mode = mode
        self.cfg = cfg
        ...
        logger.info("Constructing Tiktokdata {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        ), "Failed to load Tiktokdata split {} from {}".format(
            self._split_idx, path_to_file
        )
        logger.info(
            "Constructing Tiktokdata dataloader (size: {} skip_rows {}) from {} ".format(
    ...
    def __getitem__(self, index):
        ...
        """
        print("Retrieving item: " + str(index))
        ...
        for i_try in range(self._num_retries):
            ...
            # print("num_decode: " + str(num_decode))
            ...
            print("returning the " + str(index) + " item.")
